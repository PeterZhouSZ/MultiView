...
% load the two frames
for frame = 2: 4
im1 = im2double(imread([example sprintf('%02d.png', frame)]));
im2 = im2double(imread([example '01.png']));
...
imwrite(imflow,fullfile('output',[example sprintf('_flow_%d.jpg', frame)]),'quality',100);
end